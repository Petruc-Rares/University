...
%% au_pusca/1
%% au_pusca(-ListaNume)
au_pusca(ListaNume) :- findall(Nume, inarmat(Nume, pusca), L), sort(L, ListaNume).
...
marci_arma_unica(ListaMarci) :- setof(Marca, Marca^Crim^Dummy^(conduce(Crim, Marca), arme_marca(Marca, [Dummy])), ListaMarci).
...
suspect1(Nume:Marca:Arma) :- 
    suspect(Nume:Marca:Arma),
    arme_marca(Marca, ListaArme), 
    forall(member(ArmaTest, ListaArme), au_arma(ArmaTest, [_, _ |_])).
...
suspect2(Nume:Marca:Arma) :- 
    suspect1(Nume:Marca:Arma),
    findall(NumeCriminal, suspect1(NumeCriminal:Marca:_), [Criminal1, Criminal2 |_]).
...
suspect3(Nume:Marca:Arma) :- 
    suspect2(Nume:Marca:Arma),
    findall(NumeCriminal, suspect2(NumeCriminal:_:Arma), [Criminal1, Criminal2 |_]).
...
suspect4(Nume:Marca:Arma) :- 
    suspect3(Nume:Marca:Arma),
    findall(NumeCriminal, suspect3(NumeCriminal:Marca:_), [Criminal1, Criminal2 |_]).
...
suspect5(Nume:Marca:Arma) :- 
    suspect4(Nume:Marca:Arma),
    findall(NumeCriminal, suspect4(NumeCriminal:_:Arma), [_]).
...
suspect6(Nume:Marca:Arma) :- 
    suspect5(Nume:Marca:Arma),
    findall(NumeCriminal, suspect5(NumeCriminal:Marca:_), [_]).
