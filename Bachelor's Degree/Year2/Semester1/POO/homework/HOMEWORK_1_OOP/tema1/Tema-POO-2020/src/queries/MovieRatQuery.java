 ...
 * of type "Movie" with criteria "rating"
 */
public class MovieRatQuery {

    private final Input input;
    private final Writer fileWriter;

    public MovieRatQuery(final Input input, final Writer fileWriter) {
        this.input = input;
    ...
    public JSONObject solveQuery(final ActionInputData query) throws IOException {
        ...
        for (MovieData movie : movies) {
            Utils.filterFilmsRating(movie, null, filmsData, desiredYear, desiredGenre);
        }
