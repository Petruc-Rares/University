 ...
 * of type "Show" with criteria "rating"
 */
public class ShowRatQuery {

    private final Input input;
    private final Writer fileWriter;

    public ShowRatQuery(final Input input, final Writer fileWriter) {
        this.input = input;
    ...
    public JSONObject solveQuery(final ActionInputData query) throws IOException {
        ...
        for (SerialData serial : serials) {
            Utils.filterFilmsRating(null, serial, filmsData, desiredYear, desiredGenre);
        }
